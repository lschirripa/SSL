...
void automata1(char* cadena){
    ...
    switch(estado){
        case 11: contadorDecimal += 1; break;
        case 12: contadorOctal += 1; break;
        case 13: contadorHexa += 1; break;
        case 14: printf("Hubo un error lexico en la cadena\n"); return;
        case 15: break;
    }
...
void automata2(char* cadena){
    ...
    switch(estado){
        case 4: printf("Cadena sin error lexico\n");
                numeros[cantidadNumeros] = numeros[cantidadNumeros] * proxSigno;
                cantidadNumeros += 1;
                j = 0;
                cantOperacionesOriginal = cantidadNumeros - 1;
                    ...
                    printf("Resultado = %d\n", resultado);
                return;
        case 5: printf("Cadena con error lexico"); return;
        default: return;
    }
}
