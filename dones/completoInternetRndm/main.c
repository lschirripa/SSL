...
{
    switch (estado)
    { // "estado" seria la fila

    case 0:
        if (charLeido == '0') //case 0 es el caso de fila 1
        ...
        if (charLeido >= '1' && charLeido <= '9')
            ...
            return 3; //acá puede ser la columna 4, 5 o 6, pero simplifico en columna 4
        break;
    case 1:
        if (charLeido >= '0' && charLeido <= '9')
            return 0; // aca puede ser columna 1,2 o 3
        else
            return 3; // pueden ser 4, 5 o 6
        break;
    case 2:
        if (charLeido >= '0' && charLeido <= '7')
            return 0; //1 o 2
        ...
        break;
    case 3:
        if (charLeido >= '0' && charLeido <= '9' || charLeido >= 'a' && charLeido <= 'f' || charLeido >= 'A' && charLeido <= 'F')
            return 0; // columnas 1, 2, 3 o 4
        else
            return 4; // columna 5 o 6
        break;
    case 4:
        if (charLeido >= '0' && charLeido <= '7')
            return 0;
